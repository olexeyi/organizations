<?php $__env->startSection('content'); ?>
    <h2 class="text-xl font-bold mb-4">Добавить организацию</h2>

    <form action="<?php echo e(route('organizations.store')); ?>" method="POST" class="space-y-4">
        <?php echo csrf_field(); ?>
        ...
        <button type="submit" class="bg-blue-600 text-white px-4 py-2 rounded hover:bg-blue-500 cursor-pointer">Сохранить</button>
    </form>
